...
pub fn DequeManaged(comptime T: type) type {
    return struct {
        const Self = @This();
        ...
        pub fn moveToUnmanaged(self: *Self) DequeUnmanaged(T) {
        ...
        pub fn toOwnedSlice(self: *Self) Allocator.Error!Slice {
            ...
            const new_memory = try allocator.alignedAlloc(T, null, self.items.len);
        ...
        pub fn addManyAtAssumeCapacity(self: *Self, index: usize, count: usize) []T {
            ...
            std.mem.copyBackwards(T, self.items[index + count ..], to_move);
...
pub fn DequeUnmanaged(comptime T: type) type {
    return struct {
        ...
        pub fn toManaged(self: *Self, allocator: Allocator) DequeManaged(T) {
        ...
        pub fn shrinkAndFree(self: *Self, allocator: Allocator, new_len: usize) void {
            ...
            const new_memory = allocator.alignedAlloc(T, null, new_len) catch |e| switch (e) {
                error.OutOfMemory => {
